...
install_v2ray() {
	...
	if [[ $local_install ]]; then
		...
		pushd /tmp
		git clone https://github.com/srSPEEDiness/V2SPEED.git -b "$_gitbranch" /etc/v2ray/233boy/v2ray --depth=1
		popd
...
echo -e "╚═══════════════•⊱✦⊰•═════════════════╝" | lolcat
	...
	read -p "$(echo -e "\033[1;32m⊱ Escolha uma opção [\033[1;32m1\033[1;37m-\033[1;31m2\033[1;32m]:\033[1;37m")" choose
	case $choose in
	1)
		install
		break
